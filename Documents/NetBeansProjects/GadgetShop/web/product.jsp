...
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
         ...
         <script><%@include file="js/button.js"%></script>
            ...
            <div class="product-top flex-row">
                <div class="product-left flex-col">
                    <div class="image-container flex-row" >
                        <img src="img/sample1.png" alt="image1" width="400" height="100%"/>
                    </div>
                ...
                <div class="product-right flex-col">
                    <div class="flex-col prod-right-top">
                        <div style="color:#1B5A7D; font-size: 30px;">${Product.productName}</div>
                        <div style="color:#4A4A4A; font-size: 30px;">${Product.price}</div>
                    </div>

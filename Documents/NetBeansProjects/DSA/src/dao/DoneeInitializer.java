...
public class DoneeInitializer {
    ...
    public HashMap<Integer, Donee> initializeDonee() {
        ...
        Donee donee3 = new Donee("Siti Nurhaliza", "siti.nurhaza@example.com", "013-34567890", "Jalan Damai, Johor Bahru, 80000", DoneeCategory.FAMILY, LocalDate.of(1990, 11, 30), "Needs family support", LocalDate.of(2023, 3, 5), DoneeStatus.INACTIVE);
